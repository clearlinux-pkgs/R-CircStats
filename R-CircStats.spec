...
export LANG=C
export SOURCE_DATE_EPOCH=1521196551
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library CircStats|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
...
/usr/lib64/R/library/CircStats/data/rao.table.R
